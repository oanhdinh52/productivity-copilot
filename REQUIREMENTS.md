...
Each report has its own specification file in reports/.
All reports share the same writing principles — see AI-SKILL.md

| Report | File | Audience | Delivery |
|---|---|---|---|
| Team Lead | reports/team-lead-report.md | Team Lead | Tuesday 9AM |
| Department Manager | reports/dept-report.md | Dept Manager | Tuesday 10AM |
| CEO | reports/ceo-report.md | CEO | TBD |
